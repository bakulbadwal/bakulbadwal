...
| **[HF Learning Labs →](https://github.com/bakulbadwal/ducks-eye-view/blob/main/CASE_STUDY.md)** | Turning coursework into shipped public artifacts; honesty (exact vs. labelled toy) as a product rule |
